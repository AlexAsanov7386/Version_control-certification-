...
```sh
![наименование изображения](ссылка на изображение) добавил настоящую фразу для конфликта веток и его последующего разрешения что же произойдет сейчас, когда я солью ветки воедино и пока ничего не получается по неизвестной причине. Попробуем сейчас///
